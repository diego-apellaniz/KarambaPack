...
namespace KarambaPack
{
    public class Kar02_MMass : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            AssembleModel.solve(oldPoints, Grass, model.supports, myLoads, model.in_crosecs, model.in_materials, model.beamsets, model.joints, 0.01, out newModel, out info, out mass, out cdg, out msg, out runtime_warning);
